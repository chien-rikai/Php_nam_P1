    ...
    <div class="product_box">    
        ...
        <ul class="info_product">
            ...
            <li>
                ...
                <a href="javascript:void(0)" id="rating_1" class="no_rating" style="color: #fff" onclick="rating(1)"><i class="fas fa-star"></i></a>
                <a href="javascript:void(0)" id="rating_2" class="no_rating" style="color: #fff" onclick="rating(2)"><i class="fas fa-star"></i></a>
                <a href="javascript:void(0)" id="rating_3" class="no_rating" style="color: #fff" onclick="rating(3)"><i class="fas fa-star"></i></a>
                <a href="javascript:void(0)" id="rating_4" class="no_rating" style="color: #fff" onclick="rating(4)"><i class="fas fa-star"></i></a>
                <a href="javascript:void(0)" id="rating_5" class="no_rating" style="color: #fff" onclick="rating(5)"><i class="fas fa-star"></i></a>
            </li>
